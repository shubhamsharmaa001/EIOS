...
struct interrupt_vector const _vectab[] = {
  ...
  {0x82, (interrupt_handler_t)TRAP_IRQHandler}, /* TRAP - Software interrupt */
	{0x82, (interrupt_handler_t)TLI_IRQHandler}, /* irq0 - IMPORTal Top Level interrupt (TLI) */
  ...
  {0x82, (interrupt_handler_t)EXTI_PORTA_IRQHandler}, /* irq3 - IMPORTal interrupt 0 (GPIOA) */
	{0x82, (interrupt_handler_t)EXTI_PORTB_IRQHandler}, /* irq4 - IMPORTal interrupt 1 (GPIOB) */
	{0x82, (interrupt_handler_t)EXTI_PORTC_IRQHandler}, /* irq5 - IMPORTal interrupt 2 (GPIOC) */
	{0x82, (interrupt_handler_t)EXTI_PORTD_IRQHandler}, /* irq6 - IMPORTal interrupt 3 (GPIOD) */
	{0x82, (interrupt_handler_t)EXTI_PORTE_IRQHandler}, /* irq7 - IMPORTal interrupt 4 (GPIOE) */
	...
	{0x82, (interrupt_handler_t)EXTI_PORTF_IRQHandler}, /* irq8 - IMPORTal interrupt 5 (GPIOF) */
  ...
  {0x82, (interrupt_handler_t)EI_krnl_Tick_it/*TIM2_UPD_OVF_BRK_IRQHandler*/}, /* irq13 - TIM2 Update/Overflow/Break interrupt  */
