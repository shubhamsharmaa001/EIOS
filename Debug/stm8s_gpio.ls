 ...
 914  0098 85            	popw	x
 915  0099 81            	ret
 993                     ; 225 void GPIO_IMPORTalPullUpConfig(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin, FunctionalState NewState)
 993                     ; 226 {
 994                     	switch	.text
 995  009a               _GPIO_IMPORTalPullUpConfig:
 997  009a 89            	pushw	x
 998       00000000      OFST:	set	0
1001                     ; 228   assert_param(IS_GPIO_PIN_OK(GPIO_Pin));
1003                     ; 229   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1005                     ; 231   if (NewState != DISABLE) /* IMPORTal Pull-Up Set*/
...
1028  00b0 85            	popw	x
1029  00b1 81            	ret
1042                     	xdef	_GPIO_IMPORTalPullUpConfig
